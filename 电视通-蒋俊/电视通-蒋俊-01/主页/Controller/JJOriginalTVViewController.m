...
@interface JJOriginalTVViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JJOriginalTVViewController

static NSString *cmmbID = @"cmmbCell";
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        //注册cell(从xib注册)
        [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([JJStarTVViewCell class]) bundle:nil] forCellReuseIdentifier:cmmbID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    JJStarTVViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cmmbID forIndexPath:indexPath];
    ...
    for (NSInteger index = 1; index < 6; index++) {
        NSString *channelImage = [NSString stringWithFormat:@"1-%ld.jpg",index];
