...
@interface JJCityViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JJCityViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for (NSInteger index = 1; index < 37; index++) {
