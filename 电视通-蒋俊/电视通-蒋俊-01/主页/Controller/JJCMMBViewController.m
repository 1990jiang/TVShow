...
@interface JJCMMBViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JJCMMBViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for (NSInteger index = 1; index < 47; index++) {
