...
@interface JJCETVViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JJCETVViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for (NSInteger index = 1; index < 4; index++) {
        NSString *channelImage = [NSString stringWithFormat:@"longzhu%ld.jpg",index];
