...
#import "JJBasicTVViewController.h"
//自定义的下拉刷新控件
...
@interface JJBasicTVViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JJBasicTVViewController
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        _tableView.backgroundColor = [UIColor colorWithRed:0.9176 green:0.9569 blue:0.7569 alpha:1.0];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.channelImage.image = [UIImage imageNamed:channelImages[indexPath.row]];
